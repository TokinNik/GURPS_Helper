...
class AppSettingsVault(override val sharedPreferences: SharedPreferences) : SharedPreferencesHolder {
    ...
    var isSkillLibLoaded: Boolean by booleanDelegate(false, "is_skill_lib_loaded")
    var isAdvantageLibLoaded: Boolean by booleanDelegate(false, "is_advantage_lib_loaded")
